-- Everything a job sheet says, for visits that are agreed and have none yet.
--
-- Read off the job, never off the newest letter. A customer says "laminate, Kyle TX" one day and
-- "about 400 sq ft" the next, and a sheet built from either letter alone sends somebody out
-- knowing half of it.
--
-- Only agreed visits still ahead of us, and only those without a sheet: job_sheet_url being null
-- is what makes this run once. A visit that lapsed gets nothing -- nobody is driving anywhere.
